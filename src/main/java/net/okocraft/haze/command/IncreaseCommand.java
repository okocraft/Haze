...
public final class IncreaseCommand extends BaseCommand {

    protected IncreaseCommand() {
        super(
                "haze.increase",
                4,
                true,
                true,
                "/haze increase <point-name> <player> <amount>"
        );
    }
    ...
    public boolean runCommand(CommandSender sender, String[] args) {
        ...
        MESSAGES.sendMessage(sender, "command.increase.success", Map.of("%player%", player.getName(), "%point-name%", pointName, "%difference%", String.valueOf(amount)));
        return true;
    }
